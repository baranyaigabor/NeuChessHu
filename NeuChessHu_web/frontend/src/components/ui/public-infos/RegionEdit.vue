...
<template>
    <div class="w-full min-w-0">
        <SelectRoot :model-value="selectedCountryValue" @update:model-value="onValueChange">
            <SelectTrigger class="flex h-8 w-full min-w-0 cursor-default items-center gap-1 rounded-[5px]! border border-[var(--BorderBrush)]! bg-[var(--ButtonBrush)] px-2.5 py-1 text-sm text-[var(--FieldTextBrush)] shadow-[inset_0_2px_5px_var(--InsetShadowBrush)] outline-none focus:ring-1 focus:ring-[var(--CalendarAccentBrush)]">
                <span class="truncate">
